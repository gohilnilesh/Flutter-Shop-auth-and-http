...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProduct([bool filterByUser = false]) async {
    ...
    try {
      ...
      url = Uri.parse(
          'https://flutter-shop-a325b-default-rtdb.firebaseio.com/userFavourites/$userId.json?auth=$authToken');
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.parse(
        'https://flutter-shop-a325b-default-rtdb.firebaseio.com/products.json?auth=$authToken');
    try {
